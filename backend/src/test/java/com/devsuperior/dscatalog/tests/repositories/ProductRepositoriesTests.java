...
public class ProductRepositoriesTests {
	...
	@Test
	public void findShouldThrowInvalidDataAccessResourceUsageExceptionWhenCategoryIdDoesNotExist() {
		...
		Assertions.assertThrows(InvalidDataAccessResourceUsageException.class, () -> {
			repository.find(categories, "", pageRequest);
		});
	}
	
	@Test
	public void findShouldReturnCategoryListWhenCategoryIdExist() {
	...
	@Test
	public void findShouldReturnNothingWhenDoesNotExists() {
