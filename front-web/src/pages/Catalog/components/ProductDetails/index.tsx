...
import {ReactComponent as ProductIcon } from '../../../../core/assets/images/product.svg';
...
const ProductDetails = () => {
    let { productId }= useParams<ParamsType>();
            ...
            <div className="card-base border-radius-20 product-details">
                ...
                <div className="row">
                    ...
                    <div className="product-details-card text-center">
                        <ProductIcon className="product-details-image"/>
                    </div>
                    ...
                    <div className="col-6 product-details-card product-description">
